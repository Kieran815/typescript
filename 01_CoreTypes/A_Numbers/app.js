...
var number3 = 5;
var number4 = 2.8;
var result2 = add2(number3, number4);
...
console.log("You CAN do type checking in Vanilla JS, but it adds extra code and will cause a failure at runtime:");
function add3(n1, n2) {
...
var number5 = "5";
var number6 = 2.8;
console.log("Ex1.C: Placed @ End Since it throw an Intentional Error from Example 1:");
console.log("JavaScript `add` function w/ `typeof` forces errors:");
var result3 = add3(number5, number6);
